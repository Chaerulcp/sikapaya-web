   ...
   <div class="container" style="margin-top: 100px;">
    ...
    <div class="card" style="width: 18rem;">
       ...
       <div class="card-body">
         ...
         <p class="card-text">LG, singkatan dari Lucky-Goldstar, adalah sebuah konglomerat multinasional yang telah menjadi nama besar dunia elektronik. Perusahaan ini didirikan pada tahun 1947 dan telah mengalami transformasi sejak saat itu.</p>
