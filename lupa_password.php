...
if (isset($_POST['reset_password'])) {
    ...
    if ($user) {
        ...
        try {
            ...
            $mail->SMTPAuth = true;
            $mail->Username = 'e3f723ebd69e2c'; // Ganti dengan email Anda
            $mail->Password = '1104d73e3852b9'; // Ganti dengan password email Anda
            ...
            // Konten email
            $mail->isHTML(true);
            $resetLink = "http://localhost/sikapaya-web/reset_password.php?token=" . $token; // Ganti dengan domain Anda
